...
kubectl port-forward -n zerodt-demo svc/edge-routing-service 9901:9901
...
kubectl exec -n zerodt-demo -l app.kubernetes.io/component=edge -- curl http://localhost:9901/config_dump

# Test DNS resolution
kubectl exec -n zerodt-demo -l app.kubernetes.io/component=edge -- nslookup asg-web-pool
kubectl exec -n zerodt-demo -l app.kubernetes.io/component=edge -- nslookup monolith-web-general-pool.zerodt-demo.svc.cluster.local
```
